...
public class ExcelExample2 {
	...
	static LinkedHashMap<String,LinkedHashMap<String,LinkedHashMap<String,String>>> getInputData = new LinkedHashMap<String,LinkedHashMap<String,LinkedHashMap<String,String>>>();

	public static void main(String args[])
	{
		getExcelFileData();
		getSheetData("login");
		getTestCaseData("login", "5.0");
		getTestCaseColumnData("login", "5.0", "Password");
	}
	
	public static void getExcelFileData() {
	...
	public static void getTestCaseData(String sheetName,String testcaseName){
		System.out.println("Test case data is "+getInputData.get(sheetName).get(testcaseName));
	}
	
	//situation 3 --get data of a specific sheet, specific test case and specific column
	public static void getTestCaseColumnData(String sheetName,String testcaseName,String cellName)
	{
		System.out.println("Column data is "+getInputData.get(sheetName).get(testcaseName).get(cellName));
	}
