...
public class datepicker_example_usingJavaScriptMethods {
	...
	public static void main(String[] args) {
		...
		js.executeScript("arguments[0].value='"+"varsha_shirgaonkar"+"';",userName);
		...
		js.executeScript("arguments[0].setAttribute('style','border:2px solid red;');",welm);
		...
		WebElement birthdayimage=driver.findElement(By.xpath("//img[@id='f_trigger_c_birthday']"));
		js.executeScript("arguments[0].scrollIntoView(true);",birthdayimage);
